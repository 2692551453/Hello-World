...
<title>内容列表页面</title>
<link href="<%=basePath%>resources/css/List.css" rel="stylesheet"
	type="text/css" />
						...
						<tbody>
							...
							<c:forEach items="${messagelist }" var="message"
								...
								<tr
									...
									<td>
									   <a href="#">修改</a>&nbsp;&nbsp;&nbsp; 
									   <a href="javascript:deleteOne('${pageContext.request.contextPath }/DeleteOneServlet?id=${message.ID}');" >删除</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
